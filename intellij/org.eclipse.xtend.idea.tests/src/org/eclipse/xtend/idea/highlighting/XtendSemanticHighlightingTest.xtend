...
class XtendSemanticHighlightingTest extends LightXtendTest {
	...
	def void testRichText_0() {
		'''
			class Foo {
				def foo() «white(Q3)»«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t\t')»this is a template«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t')»«white(Q3)»
			}
		'''.checkHighlight
	}
	...
	def void testRichText_1() {
		'''
			class Foo {
				def foo() «white(Q3)»«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t\t')»this is not indented«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t\t')»	this is indented«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t\t')»this is not indented«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t')»«white(Q3)»
			}
		'''.checkHighlight
	...
	def void testRichText_2() {
		'''
			class Foo {
				def foo(String[] nums) «white(Q3)»«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t\t')»this is not indented«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t\t')»«GL»FOR i:nums«GR»«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t\t')»«white('\t')»loop body«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t\t')»«GL»ENDFOR«GR»«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t\t')»this is not indented«TEMPLATE_LINE_BREAK.$(org.eclipse.xtend.idea.highlighting.XtendSemanticHighlightingTest.NL)
			»«white('\t')»«white(Q3)»
			}
		'''.checkHighlight
