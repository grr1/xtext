...
public class XtendSemanticHighlightingTest extends LightXtendTest {
  ...
  public void testRichText_0() {
    ...
    String _$ = this.$(XtendHighlightingStyles.TEMPLATE_LINE_BREAK, XtendSemanticHighlightingTest.NL);
    _builder.append(_$, "\t");
    String _white_1 = this.white("\t\t");
    _builder.append(_white_1, "\t");
    _builder.append("this is a template");
    String _$_1 = this.$(XtendHighlightingStyles.TEMPLATE_LINE_BREAK, XtendSemanticHighlightingTest.NL);
    _builder.append(_$_1, "\t");
  ...
  public void testRichText_1() {
    ...
    String _$_2 = this.$(XtendHighlightingStyles.TEMPLATE_LINE_BREAK, XtendSemanticHighlightingTest.NL);
    _builder.append(_$_2, "\t");
    String _white_3 = this.white("\t\t");
    _builder.append(_white_3, "\t");
    _builder.append("this is not indented");
    String _$_3 = this.$(XtendHighlightingStyles.TEMPLATE_LINE_BREAK, XtendSemanticHighlightingTest.NL);
  ...
  public void testRichText_2() {
    ...
    _builder.append(XtendSemanticHighlightingTest.GR, "\t");
    String _$_4 = this.$(XtendHighlightingStyles.TEMPLATE_LINE_BREAK, XtendSemanticHighlightingTest.NL);
    _builder.append(_$_4, "\t");
    String _white_6 = this.white("\t\t");
    _builder.append(_white_6, "\t");
    _builder.append("this is not indented");
    String _$_5 = this.$(XtendHighlightingStyles.TEMPLATE_LINE_BREAK, XtendSemanticHighlightingTest.NL);
