...
public class XtendHighlightingCalculatorTest extends AbstractXtendTestCase implements IHighlightedPositionAcceptor, XtendHighlightingStyles {
	...
	@Test public void testLiteral() {
		...
		expectTemplateLineBreak(5, 1);
		expectInsignificant(6, 1);
		expectTemplateLineBreak(14, 1); //TODO shouldn't this be POSSIBLE_LINE_BREAK
	...
	@Test public void testLiteralsWithComments() {
		...
		expectTemplateLineBreak(18, 1); //TODO shouldn't this be POSSIBLE_LINE_BREAK
		expectInsignificant(19, 1);
		expectInsignificant(37, 1);
		expectTemplateLineBreak(50, 1); //TODO shouldn't this be POSSIBLE_LINE_BREAK
		expectInsignificant(51, 2);
		expectTemplateLineBreak(86, 1);
	...
	protected void expectTemplateLineBreak(int offset, int length) {
		expectAbsolute(offset, length, TEMPLATE_LINE_BREAK);
	}
